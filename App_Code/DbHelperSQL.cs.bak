...
using System.Configuration;
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static int SEARCH_PAGESIZE = 15;


        public static string connectionString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\绿色软件\Ext-FM\App_Data\mydata.mdb;Persist Security Info=False";
        ...
        {
            OleDbCommand command = BuildQueryCommand(connection, storedProcName, parameters);
            command.Parameters.Add(new OleDbParameter("ReturnValue", OleDbType.Guid, 4, ParameterDirection.ReturnValue, false, 0, 0, string.Empty, DataRowVersion.Default, null));
            return command;
        }
        #endregion
